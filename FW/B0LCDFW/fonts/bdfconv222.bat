...
rem
rem set font_name=u8g2_font_7x13B
set font_name=u8g2_font_ncenB18m
...
rem u8g2_font_ncenB18m 2d-39 
%bdfconv_2_22% -v -f 1 -m "45-57" "%~d0%~p0%font_name%.bdf" -o "%~d0%~p0%font_name%.h"  -n %font_name%
